...
export const CH01_01_LITERATE_PROGRAMMING: SectionContent = {
  ...
  "summary": {
    "keyTakeaways": [
      ...
      "책에서는 코드 조각마다 하나의 목적에 집중하고, 가능하면 열 줄보다 짧게 제시하려고 합니다. 열 줄은 문예적 프로그래밍의 필수 규칙이 아니라 저자의 설명 방침입니다."
    ],
    "prerequisites": [
  ...
  "blocks": [
    ...
    },
    {
      "type": "concept-tip",
      "badge": "💡 컴공 상식",
      "title": "문예적 프로그램과 공개 소스코드의 관계",
      "summary": "문예적 프로그램과 공개 소스코드의 관계",
      "points": [
        {
          "title": "핵심 설명",
          "content": "저자의 원래 문예적 프로그램은 문서와 컴파일할 소스코드를 함께 만드는 입력입니다. 이 학습 노트나 웹페이지의 보이는 코드만 복사하면 전체 렌더러가 완성되는 것은 아닙니다. 생략한 조각·헤더·외부 라이브러리와 빌드 설정은 소스 배포판에서 확인해야 합니다."
        }
      ],
      "tags": [
        "컴퓨터 과학 역사",
  ...
  "audit": {
    "checkedSourceSha256": "201a81bc246a10edd0da6cee502aaa06e9ad93432d1ff38f9ef58d34b21233e5",
